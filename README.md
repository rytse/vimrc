...
* **The Basic**: If you want something small just copy [basic.vim](https://github.com/rytse/vimrc/blob/master/vimrcs/basic.vim) into your ~/.vimrc and you will have a good basic setup
